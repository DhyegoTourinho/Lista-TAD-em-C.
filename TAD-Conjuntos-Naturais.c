...
void menuAux(){
    ...
    printf("|================================================================================================================|\n");
    printf("| | 1| > Criar o conjunto.                              |    |11| > Gerar complemento do conjunto                |\n");
    printf("| | 2| > Verificar se o conjunto eh vazio.              |    |12| > Gerar uniao dos conjuntos.                   |\n");
    printf("| | 3| > Inserir um elemento no conjunto.               |    |13| > Gerar intersecao entre dois conjuntos.       |\n");
    printf("| | 4| > Excluir um elemento do conjunto.               |    |14| > Gerar diferenca entre dois conjuntos.        |\n");
    printf("| | 5| > Calcular a cardinalidade do conjunto.          |    |15| > Gerar o conjunto das partes.                 |\n");
    printf("| | 6| > Verificar elementos maiores que um numero.     |    |16| > Mostrar o conjunto.                          |\n");
    ...
    printf("| | 9| > Comparar se os conjuntos sao identicos.        |    |19| > Configurar um segundo conjunto.              |\n");
...
int menuSegundoConjunto(){
    ...
    printf("|================================================================================================================|\n");
    printf("| | 1| > Criar o conjunto.                              |    |11| > Gerar complemento doconjunto                 |\n");
    printf("| | 2| > Verificar se o conjunto eh vazio.              |    |12| > Gerar uniao de dois conjuntos.               |\n");
    printf("| | 3| > Inserir um elemento no conjunto.               |    |13| > Gerar intersecao entre dois conjuntos.       |\n");
    printf("| | 4| > Excluir um elemento do conjunto.               |    |14| > Gerar diferenca entre dois conjuntos.        |\n");
    printf("| | 5| > Calcular a cardinalidade do conjunto.          |    |15| > Gerar o conjunto das partes.                 |\n");
    ...
    printf("| | 7| > Verificar elementos menores que um numero.     |    |17| > Copiar conjunto para outro.                  |\n");
    printf("| | 8| > Verificar pertinencia de um elemento.          |    |18| > Destruir conjunto.                           |\n");
    printf("| | 9| > Comparar se os conjuntos sao identicos.        |    |19| > Configurar o primeiro conjunto.              |\n");
    printf("| |10| > Verificar contigencia.                         |    |20| > Encerrar programa.                           |\n");
    printf("|================================================================================================================|\n");
    printf("Escolha uma das opcoes: ");
    scanf("%d", &escolha);
